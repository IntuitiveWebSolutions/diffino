...
eleven st,CA,66611,name eleven,11"""
        ...
        body_left = conn.Object(bucket, 'output_not_in_left.csv').get()['Body'].read().decode("utf-8")
        body_right = conn.Object(bucket, 'output_not_in_right.csv').get()['Body'].read().decode("utf-8")
